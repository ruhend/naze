...
const nyoutube = ('Bot By:\nRuli Henderson')  //ubah di config biar ngk emror
...
module.exports = naze = async (naze, m, chatUpdate, store) => {
    try {
		...
		const fkontak = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': 'Ruli Henderson', 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;Naze Dev,;;;\nFN:Naze Dev\nitem1.TEL;waid=6285875158363:6285875158363\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': thumb, thumbnail: thumb,sendEphemeral: true}}}
...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                naze.sendMessage(m.chat, { image: { url: 'https://drive.google.com/u/0/uc?id=1cEB4Jn4LREt0EKXR5yaKYLN_2Pn4D5ng&export=download' }, caption: `*${ucapanWaktu} Kak ${m.pushName}*\n\n *Info Owner*\n\n*.*\n*Silahkan Chat Owner*\n\n*.*\n_wa.me/6283122886524\n\n*Atau Transfer via*\n- *Dana*\n Ke nomer berikut : 088975984776\n\n_Terima kasih_` }, { quoted: m })
            }
            break
            case 'sc': {
                m.reply('wa.me/6283122886524')
            }
            break		 
            case 'chat': {
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: 'Daftar Menu' }, type: 1 }]
		...
		for (let yoi of anu) {
		    await sleep(3000)
                      ...
                      let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: 'Daftar Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: 'Owner' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, txt, nyoutube, m)
		}}
            break
            case 'q': case 'quoted': {
...
⭔ Url : ${anu.url}`,
		...
		let buttons = [{ buttonId: `gcsearch ${text}`, buttonText: { displayText: 'Next' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: 'Owner' }, type: 1 }]
...
let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: 'Daftar Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '👑Sewa' }, type: 1 }]
            ...
            case 'sponsor': {
            if (!m.isGroup) throw mess.group
            let qontak = `623122886524@s.whatsapp.net`
let dana = `62888975984776@s.whatsapp.net`
let shopeeotp = `623122886524@s.whatsapp.net`
let shopee = `623122886524@s.whatsapp.net`
let tokopedia = `623122886524@s.whatsapp.net`
let smartfrend = `623122886524@s.whatsapp.net`
let getcontact = `623122886524@s.whatsapp.net`
let facebook = `623122886524@s.whatsapp.net`
let pasarpolis = `623122886524@s.whatsapp.net`
let kominfo = `623122886524@s.whatsapp.net`
let alfamart = `623122886524@s.whatsapp.net`
            let ownernya = ownernomer + '@s.whatsapp.net'
            let me = m.sender
            let jawab = `*Bot by Ruli Henderson* 
...
╰──❍`
            ...
            let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: 'Daftar Menu' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: '❗Rules' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: 'Owner' }, type: 1 }]
...
│
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: 'Daftar Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
