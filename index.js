/**
   * Create By Ruli Henderson
   * Contact Me on wa.me/6283122886524
   * Follow Ruli Henderson YouTube dan IG dan Facebook
*/
    ...
    naze.ev.on('group-participants.update', async (anu) => {
        ...
        try {
            ...
            for (let num of participants) {
                ...
                if (anu.action == 'add') {
                    naze.sendMessage(anu.id, { image: { url: ppuser }, contextInfo: { mentionedJid: [num] }, caption: `Selamat Datang Di Kenalan Dulu Donk ${metadata.subject} @${num.split("@")[0]}` })
                } else if (anu.action == 'remove') {
                    naze.sendMessage(anu.id, { image: { url: ppuser }, contextInfo: { mentionedJid: [num] }, caption: `@${num.split("@")[0]} Telah Keluar Dari Grup ini Katanya Grup Ini Gak Guna Lagi ${metadata.subject}` })
